...
class CamApp(App):
    ...
    def build(self):
        ...
        self.model = tf.keras.models.load_model('siamesemodelv14Final.h5',custom_objects={'L1Dist': L1Dist})
    ...
    def verify(self,*args):
        ...
        # Capturing input image from our webcam
